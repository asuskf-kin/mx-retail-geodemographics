...
src/correr.py        corre los notebooks por ciudad y guarda los ejecutados
...
notebooks/00, 04     cliente Bepensa (solo ZM Mérida): 00 valida/cruza ventas × CP, 04 perfil por PDV en hexágonos a ≤300 m
...
python src/correr.py --pasos 00,01,02,03,04 merida   # Bepensa: 00 no depende de nadie; 04 necesita 00, 01 y 02
```
Orden para Bepensa: **00 → 01 → 02 → 03 → 04** (00 solo usa los datos del cliente y el Marco Geoestadístico, que descarga solo). Los notebooks también se pueden abrir y correr a mano en VS Code/Jupyter
...
Ciudades configuradas: `merida`, `guadalajara`. Fuentes: Censo 2020, ENIGH 2024, Marco Geoestadístico 2025, DENUE 05_2026, Regla AMAI 2024. Las salidas de Mérida previas a la parametrización por ciudad
...
- Radio 1 km: mediana ≈ 3,971 hogares por tienda (500 m: 1,112). Con MG 2020 era 3,981.
- Con MG 2025: 19,596 manzanas; 83 manzanas del Censo sin polígono (1,171 hogares, 0.33%); 63 tiendas fuera de AGEB (con MG 2020: 112).
...
- 04: mediana 18 hexágonos por área (≈ 0.27 km²); 576 PDV sin hogares a ≤ 300 m.
